          ...
          <div className="max-w-xl space-y-5 pt-2">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl font-bold tracking-tight text-slate-950 sm:text-5xl lg:text-6xl">
                Coaching and support designed for steady, sustainable progress.
              </h1>
              <p className="max-w-2xl text-base leading-8 text-slate-600 sm:text-lg">
                Personal training, group classes, and wellness programs tailored
                to help users stay consistent without overwhelm.
              </p>
            </div>
              ...
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <h3 className="mt-2 text-2xl font-semibold text-white sm:text-3xl">
                    Structured support without pressure.
                  </h3>
                </div>
              ...
              <div className="grid gap-4 sm:grid-cols-[1.2fr_0.8fr]">
                <div className="rounded-[1.5rem] border border-white/10 bg-white/8 p-5 backdrop-blur-sm">
                  <div className="mb-5 flex items-center justify-between text-white/70">
                    <span className="text-sm">Coaching rhythm</span>
                    <span className="text-sm">Steady outcomes</span>
                  </div>
                  <div className="space-y-4">
                    {[
                      {
